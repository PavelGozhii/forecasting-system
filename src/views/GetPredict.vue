<template>
    <div style="overflow-x: hidden">
        ...
        <div class="row mt-5 m-5">
            <div class="col-4">
                <div class="btn-group">
                    <button style="width: 300px" type="button" class="btn btn-danger btn-lg dropdown-toggle"
                            data-bs-toggle="dropdown" aria-expanded="false">
                        {{selectedTown}}
                    </button>
                    <ul class="dropdown-menu" style="width: 300px">
                        <li v-for="(item, index) in settlements" :key="index" @click="selectTown(item)">{{item.name}},
            ...
            <div class="col-4">
                <table class="table">
                    ...
                    <tbody>
                    <tr v-for="(item, index) in indicators" :key="index" @click="selectIndicator(item)"
        ...
        <div>
            <field-state id="1" v-if="regression.year.length" :x="regression.x" :y="regression.y"
                         :dates="regression.year"></field-state>
        </div>
        <div>
            <field-state id="1" v-if="extrapolation.value.length" :x="extrapolation.value"
                         :dates="extrapolation.year"></field-state>
        </div>
    </div>
</template>
